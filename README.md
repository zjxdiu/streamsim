...
3. Setup your API info and other settings down the page. Only Openai compatible API is supported, and you should double check if the model supports image input.
...
2. Can't share screen: If your page is loaded in http and domain is not localhost/127.0.0.1, then the screen capture won't work.
